...
TELEGRAM_BOT_TOKEN = '6796068761:AAHtMEUagmrnJb7jVY--AuSvEkoCLclEz8I'
...
def handle_messages(update, context: CallbackContext) -> None:
    ...
    if 'instagram.com/p/' in message.text:
        send_messages = message.reply_text("Veuillez patienter,  télédéchargement du post en cours...")
        ...
        try:
            ...
            print("Erreur de traitement du post Instagram :", str(e))
            message.reply_text("Erreur de traitement du post Instagram :", str(e))
        ...
        message.reply_text("Veuillez envoyer l'URL d'une publication Instagram valide.")
